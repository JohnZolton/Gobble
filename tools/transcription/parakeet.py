...
if __name__ == "__main__":
    audio_file = "output/audio/youtube/Andrew_Huberman/Behaviors_That_Alter_Your_Genes_to_Improve_Your_Health_&_Performance_Dr._Melissa_Ilardo.mp3"
    segment_length = 60  # Length of audio segments in seconds
    
    start = time.time()
    transcribe_audio(audio_file, segment_length)
    end =  time.time() - start
